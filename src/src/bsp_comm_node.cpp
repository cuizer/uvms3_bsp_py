...
=======
        inertial_sub_     = this->create_subscription<uvms3_test::msg::HalInertialnavi>("/hal/inertialnavi",qos,std::bind(&BspCommNode::inertial_callback, this, std::placeholders::_1));
        dvl_sub_          = this->create_subscription<uvms3_test::msg::HalDvl>("/hal/dvl",qos,std::bind(&BspCommNode::dvl_callback, this, std::placeholders::_1));
        depthsensor_sub_  = this->create_subscription<uvms3_test::msg::HalDepthsensor>("/hal/depthsensor",qos,std::bind(&BspCommNode::depthsensor_callback, this, std::placeholders::_1));
        mainthruster_sub_ = this->create_subscription<uvms3_test::msg::HalMainthruster>("/hal/mainthruster",qos,std::bind(&BspCommNode::mainthruster_callback, this, std::placeholders::_1));
        auxithruster_sub_ = this->create_subscription<uvms3_test::msg::HalAuxithruster>("/hal/auxithruster",qos,std::bind(&BspCommNode::auxithruster_callback, this, std::placeholders::_1));
        battery_sub_      = this->create_subscription<uvms3_test::msg::HalBattery>("/hal/battery",qos,std::bind(&BspCommNode::battery_callback, this, std::placeholders::_1));
        tailservo_sub_    = this->create_subscription<uvms3_test::msg::HalTailservo>("/hal/tailservo",qos,std::bind(&BspCommNode::tailservo_callback, this, std::placeholders::_1));
        armmotor_sub_     = this->create_subscription<uvms3_test::msg::HalArmmotor>("/hal/armmotor",qos,std::bind(&BspCommNode::armmotor_callback, this, std::placeholders::_1));
        antenna_sub_      = this->create_subscription<uvms3_test::msg::HalAntenna>("/hal/antenna",qos,std::bind(&BspCommNode::antenna_callback, this, std::placeholders::_1));
...
>>>>>>> cf0e073 (Add lifecycle node status monitoring and UDP transmission):src/bsp_comm_cpp_pkg/src/bsp_comm_node.cpp
...
// ================= 打印函数 =================
    ...
    // ---------- Antenna ----------
        ...
        if (lifecycle_states_data_.has_value())
        {
            ...
            auto packet = build_packet(0x13, payload);
...
=======
    rclcpp::Subscription<uvms3_test::msg::HalInertialnavi>::SharedPtr inertial_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalDvl>::SharedPtr dvl_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalDepthsensor>::SharedPtr depthsensor_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalMainthruster>::SharedPtr mainthruster_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalAuxithruster>::SharedPtr auxithruster_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalBattery>::SharedPtr battery_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalTailservo>::SharedPtr tailservo_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalArmmotor>::SharedPtr armmotor_sub_;
    rclcpp::Subscription<uvms3_test::msg::HalAntenna>::SharedPtr antenna_sub_;
...
=======
    ...
    std::optional<uvms3_test::msg::HalDvl> dvl_data_;
    std::optional<uvms3_test::msg::HalDepthsensor> depthsensor_data_;
    std::optional<uvms3_test::msg::HalMainthruster> mainthruster_data_;
    std::optional<uvms3_test::msg::HalAuxithruster> auxithruster_data_;
    std::optional<uvms3_test::msg::HalBattery> battery_data_;
    std::optional<uvms3_test::msg::HalTailservo> tailservo_data_;
    std::optional<uvms3_test::msg::HalArmmotor> armmotor_data_;
    std::optional<uvms3_test::msg::HalAntenna> antenna_data_;
