...
private:
    ...
    // 行顺序对应 /hal/thruster/cmd: [主推0x301, 辅推ID2, ID3, ID4, ID5, ID6]
    static constexpr std::array<std::array<double, 6>, 6> T_PINV = {{
        {  0.74226804, -0.18556701,  0.00000000,  0.00000000,  0.00000000,  0.41237113 }, // 主推 0x301
        {  0.00000000,  0.00000000,  0.45871560,  5.00000000,  0.13761468, -0.00000000 }, // 辅推 ID2
        {  0.00000000, -0.00000000,  0.45871560, -5.00000000,  0.13761468,  0.00000000 }, // 辅推 ID3
        { -0.10309278,  0.52577320, -0.00000000,  0.00000000, -0.00000000,  2.16494845 }, // 辅推 ID4
        {  0.10309278,  0.47422680,  0.00000000, -0.00000000,  0.00000000, -2.16494845 }, // 辅推 ID5
        {  0.41237113, -0.10309278, -0.00000000, -0.00000000, -0.00000000,  1.34020619 }  // 辅推 ID6
    }};
